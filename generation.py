...
def fetch_code_information():
    ...
    if combined_information == "":
        try:
            ...
            promptT = (
                f"Query is {query}. You are a helpful assistant designed to assist new developers in retrieving code snippets that adhere "
            ...
            error_message = f"Error analyzing code snippet: {str(e)}"
            return jsonify({
